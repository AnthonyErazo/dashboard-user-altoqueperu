                        ...
                        {filteredOrders.length > 0 ? (
                            filteredOrders.map((order, index) => (
                                <li key={index} className="flex items-center gap-4 border-b pb-4">
                                    <div
                                        className={`h-10 w-10 rounded-full flex items-center justify-center ${order.status === "Exitoso"
                                            ? "bg-green-500"
                                    ...
                                    >
                                        {order.status === "Exitoso" && <Check color="green" />}
                                        {order.status === "En proceso" && <Clock color="blue" />}
                                        {order.status === "Fallido" && <CircleXIcon color="red" />}
                                    </div>
