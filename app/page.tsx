...
export default function Home() {
  ...
  return (
    <div className="h-[100vh] flex flex-col justify-between">
      <div className="flex justify-center py-8 text-gray-700">
        {steps?.map((step, i) => (
        ...
        <div className="flex flex-col justify-between">
          ...
          {currentStep === 3 && (
            <div className="flex flex-col md:flex-row justify-between p-6 gap-6">
                ...
                <div className="flex justify-center items-center">
                  {selectedBank ? (
                    <img
                      ...
                      style={{ maxHeight: '200px' }}  // Ajusta el tamaño máximo de la imagen
                    />
                  ) : (
                    <Typography variant="body1" color="textSecondary">
              ...
              {/* Área para subir el archivo (voucher) */}
              <motion.div
                initial={{ opacity: 0 }}
                animate={{ opacity: 1 }}
                transition={{ duration: 0.8 }}
              ...
              >
                ...
                <div className="flex flex-col items-center">
                  <Box className="mb-6 w-full border border-dashed border-gray-300 p-4 rounded-lg bg-gray-50 relative">
                    <input
                      type="file"
      ...
      {/* Navigation Buttons */}
      <motion.div
        className="flex justify-between items-center py-6 text-gray-800 px-16 bg-white shadow-lg"
        initial={{ opacity: 0, translateY: 30 }}
        animate={{ opacity: 1, translateY: 0 }}
        transition={{ duration: 0.5 }}
      >
